    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="grid grid-cols-3">
            ...
            <div class="flex items-center justify-center">
                <ol class="md:flex items-center space-x-1 md:space-x-3 hidden">
                ...
                >
                    <div class="relative">
                        ...
                        >
                            ...
                            @else
                                <div class="hidden md:flex mr-2 relative items-center justify-center w-8 h-8 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
